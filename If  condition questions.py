...
if temp>45:
  print("temp exceeds 45c")
  
Q7.Check if a string length is more than 8 characters.

text=input("Enter a string:")
if len(text)>8:
    print("String length is more than 8 character")

Q8.Check if a number is a multiple of 10.

num=int(input("Enter a number:"))
if num%10==0:
    print("number is multiple of 10")
    
Q9.Print "Logged In" if password matches "admin123".
